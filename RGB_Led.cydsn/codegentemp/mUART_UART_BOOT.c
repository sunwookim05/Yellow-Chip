...
/*******************************************************************************
* Function Name: mUART_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: mUART_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: mUART_UartCyBtldrCommReset
****************************************************************************//**
*
...
void mUART_UartCyBtldrCommReset(void)
{
    ...
    mUART_SpiUartClearRxBuffer();
    mUART_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: mUART_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != mUART_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = mUART_SpiUartGetRxBufferSize();
                    CyDelayUs(mUART_UART_BYTE_TO_BYTE);
                }
                while (byteCount != mUART_SpiUartGetRxBufferSize());

                byteCount = mUART_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) mUART_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: mUART_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus mUART_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        mUART_SpiUartPutArray(pData, (uint32) size);
