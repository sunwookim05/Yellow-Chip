...
module SCB_P4_v4_0_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("3dbba19d-7851-4a83-b204-a0a386fe8d68/38438ec5-732c-47a6-9805-e2b697fb82a2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3dbba19d-7851-4a83-b204-a0a386fe8d68/ed092b9b-d398-4703-be89-cebf998501f6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3dbba19d-7851-4a83-b204-a0a386fe8d68/9613317f-9767-4872-a15a-e07325d93413"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__pLed_net;
	wire [0:0] tmpFB_0__pLed_net;
	wire [0:0] tmpIO_0__pLed_net;
	wire [0:0] tmpINTERRUPT_0__pLed_net;
	electrical [0:0] tmpSIOVREF__pLed_net;
	...
	cy_psoc3_pins_v1_10
		...
		pLed
		 (.oe(tmpOE__pLed_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pLed_net[0:0]}),
		  .io({tmpIO_0__pLed_net[0:0]}),
		  .siovref(tmpSIOVREF__pLed_net),
		  .interrupt({tmpINTERRUPT_0__pLed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pLed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__pOledReset_net;
	wire [0:0] tmpFB_0__pOledReset_net;
	wire [0:0] tmpIO_0__pOledReset_net;
	wire [0:0] tmpINTERRUPT_0__pOledReset_net;
	electrical [0:0] tmpSIOVREF__pOledReset_net;

	cy_psoc3_pins_v1_10
		#(.id("14589af3-8cd6-4b7c-a84b-e19de998f782"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pOledReset
		 (.oe(tmpOE__pOledReset_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pOledReset_net[0:0]}),
		  .io({tmpIO_0__pOledReset_net[0:0]}),
		  .siovref(tmpSIOVREF__pOledReset_net),
		  .interrupt({tmpINTERRUPT_0__pOledReset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pOledReset_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pOledDc_net;
	wire [0:0] tmpFB_0__pOledDc_net;
	wire [0:0] tmpIO_0__pOledDc_net;
	wire [0:0] tmpINTERRUPT_0__pOledDc_net;
	electrical [0:0] tmpSIOVREF__pOledDc_net;

	cy_psoc3_pins_v1_10
		#(.id("7fac5c7d-b340-494c-be6e-5c73476657ec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pOledDc
		 (.oe(tmpOE__pOledDc_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pOledDc_net[0:0]}),
		  .io({tmpIO_0__pOledDc_net[0:0]}),
		  .siovref(tmpSIOVREF__pOledDc_net),
		  .interrupt({tmpINTERRUPT_0__pOledDc_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pOledDc_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
