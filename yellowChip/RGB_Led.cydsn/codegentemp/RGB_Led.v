// ======================================================================
// RGB_Led.v generated from TopDesign.cysch
// 07/28/2022 at 15:18
...
module CapSense_P4_v7_0_1 ;
    ...
    cy_psoc4_csd2_v1_30 CSD (
        ...
        .tx(Net_121),
        .vref_ext(Net_150));
    defparam CSD.adc_channel_count = 2;
	...
	wire [1:0] tmpOE__AdcInput_net;
	wire [1:0] tmpFB_1__AdcInput_net;
	wire [1:0] tmpIO_1__AdcInput_net;
	wire [0:0] tmpINTERRUPT_0__AdcInput_net;
	electrical [0:0] tmpSIOVREF__AdcInput_net;

	cy_psoc3_pins_v1_10
		#(.id("19348b31-266a-4ec4-97a6-6a064ea78989/30182841-2754-4aee-9532-9ff02059dfef"),
		...
		AdcInput
		 (.oe(tmpOE__AdcInput_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__AdcInput_net[1:0]}),
		  .analog({Net_132[1:0]}),
		  .io({tmpIO_1__AdcInput_net[1:0]}),
	...
	assign tmpOE__AdcInput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("02817fad-8ba3-4463-bd26-20cbf9163072"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("32922871-45db-4cd5-a363-d1605b22ad73"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
